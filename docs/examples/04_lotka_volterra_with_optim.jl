...
const EXPLORATION_DIR = 2           #Hessian eigenvector index selected for curve evolution

# ## Model Definition via ModelingToolkit (MTK)
...
# ## Generate Baseline Experimental Features ("Truth")
...
@time mdc_curves = MDCSolve(mdc_sys, span = MDCSpan(-3.0, 10.0); callback = my_pipeline)
...
#md # ![MTK Lotka Volterra MDC Sweep](lotka_volterra_mtk_mdc.gif)
