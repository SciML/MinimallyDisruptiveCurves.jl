...
# Which eigenvector (direction) to explore along the manifold. They tend to be iteratively more disruptive.
which_dir = 1

# ## Simulator (Lotka-Volterra)
...
mdc_curves = MDCSolve(sys, span = MDCSpan(-3.0, 8.0))
...
#md # ![Lotka Volterra MDC Sweep](lotka_volterra_mdc.gif)
